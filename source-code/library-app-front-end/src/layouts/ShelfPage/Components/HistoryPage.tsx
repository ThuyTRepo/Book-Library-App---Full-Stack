    ...
    useEffect(() => {
        const fetchUserHistory = async () => {
            if (authState && authState.isAuthenticated) {
                const url = `${process.env.REACT_APP_API}/histories/secure?page=${currentPage - 1}&pageSize=5`;
                ...
                setHistories(historyResponseJson.data.items);

                setTotalPages(Math.ceil(historyResponseJson.data.total / 5));
            }
