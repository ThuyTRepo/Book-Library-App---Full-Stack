...
export const ChangeQuantityOfBook: React.FC<{ book: BookModel, deleteBook: any }> = (props, key) => {
    ...
    async function increaseQuantity() {
        const url = `${process.env.REACT_APP_API}/books/secure/admin/increase/quantity/?bookId=${props.book?.id}`;
    ...
    async function decreaseQuantity() {
        const url = `${process.env.REACT_APP_API}/books/secure/admin/decrease/quantity/?bookId=${props.book?.id}`;
        const requestOptions = {
            method: 'PATCH',
            headers: {
                Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
    ...
    async function deleteBook() {
        const url = `${process.env.REACT_APP_API}/books/secure/admin?bookId=${props.book?.id}`;
        const requestOptions = {
            method: 'DELETE',
            headers: {
                Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
